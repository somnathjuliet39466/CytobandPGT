...
var drawCircos = function (error, GRCh37, cytobands, data) {
  ...
  var innerRadius = width / 2 - 80; // Inner radius of cytobands
  var outerRadius = width / 2 - 40; // Outer radius of cytobands
  ...
  circos
    .layout(GRCh37, {
      ...
      labels: {
        radialOffset: 70, // Offset labels from the blocks
        size: 14, // Increased font size to 18px
    ...
    // Highlight cytobands with consistent radii
