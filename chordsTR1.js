...
var drawCircos = function (error, GRCh37, cytobands, data) {
  ...
  circos
    .layout(GRCh37, {
      ...
      labels: {
        radialOffset: 150, // Increased offset for labels
      ...
      ticks: {
        ...
        spacing: 10, // Set tick spacing (adjust as needed)
        labelDenominator: 1000000, // Display ticks in megabase units
        size: 20, // Increase font size for tick labels
